  ...
  real(kind=8),parameter::bt=0.1d0
!real(kind=8),parameter::op=2*pi/12.0d0  
!real(kind=8),parameter::bt=0.1d0  
  real(kind=8),parameter::bp=1.0d0
...
!calculating variances, \delta\theta^2 and \delta\phi^2 
    ...
    write(13,*) xa,xc,delt
    write(14,*) xa,xc,delp
    write(6,*) 'standard deviation for \delta\theta and \delta\phi',sqrt(delt),sqrt(delp)
